...
class CompaActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_compa)

        val drawerLayout : DrawerLayout = findViewById(R.id.drawerlayoutCompa)
        val navView : NavigationView = findViewById(R.id.nav_viewCompa)
